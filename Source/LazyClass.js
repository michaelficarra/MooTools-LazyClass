		...
		load: function(){
			var klass,
				...
				addToScope = function(){
					...
					if(klass===undefined || klass===this.preparedClass) klass = globalScope[this.klass];
			...
			new Request({
				...
				onFailure: function(xhr){
					...
					// UGLY!
					while(!globalScope[this.klass] && (now=Date.now())-start<timeout); */
					addToScope();
				}.bind(this),
